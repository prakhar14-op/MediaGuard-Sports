...
import { validateAdjudicateRequest, validateBatchAdjudicate } from "../middleware/validate.js";
...
router.post("/adjudicate/batch",   validateBatchAdjudicate,   wrapAsync(batchAdjudicate));
